...
username="20009200044"
password="Zz13773606509"
url="https://xxcapp.xidian.edu.cn/uc/wap/login/check"
p1=requests.Session()
p2=p1.post(url,headers = headers,data={"username":username,"password":password})
p2=p1.post("https://xxcapp.xidian.edu.cn/xisuncov/wap/open-report/save",headers=headers,data=data)
